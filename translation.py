...
Step 2: Reply to that message with /rename newname .extension. EG : /rename BG(Bot_Gram)_Intro . mp4

🤟🏻 Make sure you don't something illegal🤟🏻

Support Group : @The_Bot_Gram
👑 @BG_OFFICIAL """
